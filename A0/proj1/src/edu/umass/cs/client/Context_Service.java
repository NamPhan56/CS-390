...
public class Context_Service extends Service{
	...
	private void showNotification() {
        ...
        if(isAccelerometerRunning())
        	notification.setLatestEventInfo(getApplicationContext(), "Accelerometer Demo", "Accelerometer Running", contentIntent);
        else
        	notification.setLatestEventInfo(getApplicationContext(), "Accelerometer Demo", "Accelerometer Not Started", contentIntent);
